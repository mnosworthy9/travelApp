...
public class cn_tower extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cn_tower);
        ListView attractionDetails = (ListView) findViewById(R.id.attraction_list);

        Toast.makeText(getBaseContext(), "Travel to the CN Tower", Toast.LENGTH_LONG).show();
